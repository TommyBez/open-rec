...
3. **User-facing export queue inspector**
   - Show active export job IDs + lifecycle timestamps in the UI
   - Useful when reconciling long-running background export activity

## Reliability / observability enhancements

4. **Structured telemetry for lifecycle event ordering**
...
5. **Configurable timeout presets**
